...
public class LogInUsernameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_log_in_username);

        usernameInput = findViewById(R.id.login_username);
        letMeInBtn = findViewById(R.id.login_let_me_id_btn);
    ...
    void setUsername() {
        ...
        if (userModel!=null){
            ...
            userModel = new UserModel(phonenumber , username , Timestamp.now() , FirebaseUtil.currrentUserId());
        }
